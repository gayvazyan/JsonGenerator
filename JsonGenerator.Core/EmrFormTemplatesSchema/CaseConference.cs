...
public class CaseConference
{
    ...
    [Required(ConditionGroup = EmrFormTemplatesSchema.NeedToSign.OnlyDoctor)]
    [Required(ConditionGroup = EmrFormTemplatesSchema.NeedToSign.Both)]
    public string DoctorSignuture { get; set; }

    [Required(ConditionGroup = EmrFormTemplatesSchema.NeedToSign.OnlyPatient)]
    [Required(ConditionGroup = EmrFormTemplatesSchema.NeedToSign.Both)]
